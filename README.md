...
| **Ridge (推薦)** | **0.45** | **1.06** | **1.57** | **2.24** |

## 結論
- **短期(1h)**: 直前値(Persistence)が最強。MLによる改善余地は僅少。
- **長期(168h)**: Ridge(α=2000)がベースライン比 **-18.8%** の劇的な精度改善を達成。
- **実用性**: 計画業務（中長期予測）においてMLモデルは極めて高い付加価値を提供可能。
